...
import 'package:qurani_tukufu/di/injection.dart';
import 'package:qurani_tukufu/models/ayah.dart';
import 'package:qurani_tukufu/models/multi_text.dart';
import 'package:qurani_tukufu/models/user.dart';
import 'package:qurani_tukufu/modules/ayah/screens/ayahs_screen.dart';
...
class _AyahDetailScreenState extends State<AyahDetailScreen> {
  ...
  void initState() {
    Future.delayed(Duration.zero, () {
      if (_args?.ayahs.isNotEmpty ?? false) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title:
              MultiLanguageText(_args?.surahTitle, space: 0, isVertical: false),
