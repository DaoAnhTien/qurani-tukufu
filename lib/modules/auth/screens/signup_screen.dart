...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void _submitLogin(BuildContext context) {
    if (_formKey.currentState!.validate()) {
      context.read<AuthCubit>().register(nameController.text,emailController.text,
